...
return (
<div>
<Header title="Task manager testing git still testing extragit push -u origin old_branch removing some content"  onAdding={()=>setShowAddTasks(!showaddtasks)} showtasks={showaddtasks} />
